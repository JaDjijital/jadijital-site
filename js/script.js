(function () {
  ...
  var levelData = [
    { title: 'WEB TASARIM & YAZILIM', category: 'DİJİTAL VİTRİN', accent: CYAN, image: 'assets/images/service-webdesign-bg.jpeg', desc: 'Güçlü tasarım anlayışımızı modern yazılım çözümleriyle birleştirerek markanıza özel web siteleri geliştiriyoruz. Estetik, hızlı, mobil uyumlu ve güvenilir altyapılarla hem dikkat çeken hem de işlevsel dijital deneyimler oluşturuyoruz.' },
